...
from schemas.book import BookCreate, BookUpdate, Book as BookSchema, BookWithDetails, BookSave
...
class BookService:
    ...
    def save_for_user(self, db: Session, user_id: int, book_save: BookSave) -> BookSchema:
